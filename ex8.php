...
<body>
	<div class="w3-container w3-half w3-margin-top">
		<form class="w3-container w3-card-4" method="POST">
			...
			<br>
			<input class="w3-check" type="checkbox" name="hobbies" value="Gym">
			<label>Gym</label>
			<br>
			<input class="w3-check" type="checkbox" name="hobbies" value="Gaming">
			<label>Gaming</label>
			<br>
			<input class="w3-check" type="checkbox" name="hobbies" value="Hiking">
			<label>Hiking</label>
			<br>
			<br>
	...
	<div class="w3-container w3-half w3-margin-top w3-card-4">
		...
		<br>
		<img src="<?php echo $photo; ?>" class="w3-round" alt="image.jpg" width="250" height="250">
		<hr>

...
<tr><td>
	<form method="POST">
		<center><h1><b><i><font color=yellow >String Operations</font></i></b></h1></center>
		<br>
  ...
  <br>
  <br>
  <center><input class="w3-button w3-yellow" type="submit" name="form_submit" value="Submit"></center>
	</form>
	<br>

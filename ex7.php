...
<tr><td>
	<div id="page-wrap">
        ...
        <br>
        <br>
		<h1><b><i><font color=yellow class="w3-center">Electricity Bill</font></i></b></h1>
        <br>
		<form action="" method="post" class="w3-container w3-xlarge">
            	<input class="w3-input" type="number" name="units" placeholder="Enter the units!!!" />
                <br>
            	<center><input class="w3-button w3-yellow" type="submit" name="unit-submit" id="unit-submit" value="Check" /></center>
		</form>
		<div>
